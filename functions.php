...
function my_post_queries( $query ) {
    ...
    if (!is_admin() && $query->is_main_query()){
        ...
        if ($query->is_main_query() && $query->is_post_type_archive('individual') && !is_admin())
...
if (function_exists('add_theme_support'))
{
    ...
    add_image_size('medium-thumbnail', 400, 225, true);
    add_image_size('club-thumbnail', 400, 300, true);
    add_image_size('portrait', 700, 900, true);
